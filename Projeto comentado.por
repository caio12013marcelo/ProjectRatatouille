	...
	funcao inicio()
	{
		...
		enquanto(invalid){//faz com que entre em loop
			enquanto(invalid){//rodará até entrar no (para),onde o invalid se tornará falso e nao nao conseguirá mais fazer o loop 
				...
				se(invalid==verdadeiro){//o usuario digita um numero,o "para" verifica es nao bater ele invalida
					escreva(" ## SENHA OU USUARIOS ERRADOS ## \n")
				}
			}
			enquanto(opc!=4){//vai rodar ate o usuario digitar a opcao 4 (encerrar)
			...
			escolha(opc){//opcoes (1,2,3 ou 4)
				...
				caso 2://saque
					...
					se(saque>saldo[numUsuario]){//se o saque for maior que o saldo,dará invalido  
						...
						//sera usado para fazer os calculos de diminuicao do "resto" para pegar todas as notas que serao entegues,nao estará afetando o saque 
						restante=saque
						//mostra o nome do usuario localizado no vetor (usuario) 
						...
						se(restante>=100){//maior ou igual a 100
								se(restante>=100 e restante<=4000){//se maior ou igual a 100 (e) menor ou igual a 4000 que é o limite de notas somadas
									...
									valor100=40//entrega o maximo de notas de 100
								}
						...
						se(restante % 2 == 0 e restante>=2 ou restante==3){//se for divisisivel por 2 com resto zero (e) maior ou igual a 2 (ou) igual a 3  
							se(restante>=2 e restante <=30){//se o resto for maior ou igual a 2 (e) menor ou igual a 30 que é o limite de notas somadas  
						...
						se(restante==7 ou restante==9){
							...
							escreva(" * 5 Ratatouilles: ",valor5,"\n")//informea a quantia de notas entregues (o valor mudará se o resto for 7 ou 9)
							escreva(" * 2 Ratatouilles: ",valor2,"\n")
						}
				...
				caso 3://deposito
					...
					pare
				caso 4://sair
					limpa()//limpa todo o codigo menor a frase "ate a proxima"
					escreva(" ## Até a proxima ## \n")
					pare
				caso contrario://se o usuario digitar numeros sem ser os da opcao (1,2,3 ou 4),será invalidado 
